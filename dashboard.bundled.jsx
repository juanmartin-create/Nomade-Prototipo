    ...
    <aside style={{
      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 8 }}>
          <img src={window.__resources.avatar_2} style={{ width: 32, height: 32, borderRadius: 999 }} />
          <div>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 16, position: "sticky", top: 92 }}>
        ...
        <div className="card" style={{ padding: 20 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", marginBottom: 14 }}>
            {[
              window.__resources.cohort_1,
              window.__resources.cohort_2,
              window.__resources.cohort_3,
              window.__resources.cohort_4,
              window.__resources.cohort_5,
            ].map((src, i) => (
