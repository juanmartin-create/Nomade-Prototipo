      ...
      <div className="container" style={{ display: "grid", gridTemplateColumns: "1.05fr 1fr", gap: 56, alignItems: "center", position: "relative" }}>
        ...
        <div style={{ position: "relative", height: 580 }}>
          ...
          <div style={{
            ...
            <img src="https://images.unsplash.com/photo-1543783207-ec64e4d95325?w=900&q=80&auto=format&fit=crop" alt="Madrid"
        ...
        <div style={{ position: "relative" }}>
          <div style={{
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 20 }}>
              <img src="https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=80&h=80&fit=crop" style={{ width: 44, height: 44, borderRadius: 999 }} />
              <div>
